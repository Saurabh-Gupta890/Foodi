    ...
    <div>
      ...
      <footer className={`footer xl:px-24 py-10 px-4 text-base-content ${
        ...
        <nav>
          ...
          <a className="link link-hover">+91 958 248 9661</a>
      ...
      <footer  className={`footer items-center xl:px-24 px-4 py-4 mt-2 ${
        ...
        <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
          <a href="https://twitter.com/Swiggy?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" target="blank">
            <svg
          ...
          <a href="https://www.youtube.com/watch?v=vTA7li3tVV4" target="blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
